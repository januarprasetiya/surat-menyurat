                    ...
                    <div class="col-md-9 col-sm-12">
                       <div class="portlet light">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?= site_url('admin/proses_edit_pejabat_fakultas/' . encrypt_url($id_fakultas) . '/' . encrypt_url($data_pejabat['id_pejabat_fakultas'])) ?>" method="POST" id="form_sample_2" class="form-horizontal" novalidate="novalidate">
                            <?= csrf_field() ?>
								<div class="form-body">
                                    <?php if($validation->hasError('niyp_pejabat') || $validation->hasError('nama_pejabat') || $validation->hasError('masa_mulai') || $validation->hasError('masa_akhir') || $validation->hasError('periode')) { ?>
									...
									<div class="form-group <?= ($validation->hasError('niyp_pejabat')) ? 'has-error' :'' ?>">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" placeholder="NIY / NIP Pejabat" name="niyp_pejabat" value="<?= $data_pejabat['niyp_pejabat'] ?>" autofocus>
									...
									<div class="form-group <?= ($validation->hasError('nama_pejabat')) ? 'has-error' :'' ?>">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" placeholder="ex: Dr. Nama, M.Pd., Ph.D." name="nama_pejabat" value="<?= $data_pejabat['nama_pejabat'] ?>">
											<span class="help-inline">
                                    ...
                                    <div class="form-group <?= ($validation->hasError('jabatan')) ? 'has-error' :'' ?>">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" placeholder="Masukkan jabatan" name="jabatan" value="<?= $data_pejabat['jabatan'] ?>">
											<span class="help-inline">
                                    ...
                                    <div class="form-group <?= ($validation->hasError('periode')) ? 'has-error' :'' ?>">
										...
										<div class="col-md-9">
											<select name="periode" class="form-control" style="width:300px">
                                                <option value="<?= encrypt_url($periode_pejabat['id_periode_fakultas'] ) ?>" selected><?= esc($periode_pejabat['nama_periode_fakultas']) ?></option>
                                    ...
                                    <div class="form-group <?= ($validation->hasError('masa_mulai') || $validation->hasError('masa_akhir')) ? 'has-error' :'' ?>">
										...
										<div class="col-md-4">
											<div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control" name="masa_mulai" value="<?= $data_pejabat['masa_mulai'] ?>">
												<span class="input-group-addon">
												s.d. </span>
												<input type="text" class="form-control" name="masa_akhir" value="<?= $data_pejabat['masa_akhir'] ?>">
											</div>
											<!-- /input-group -->
