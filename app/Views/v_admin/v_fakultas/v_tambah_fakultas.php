                       ...
                       <div class="portlet light">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Tambah data fakultas</span>
							</div>
                            <div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?= site_url('admin/proses_tambah_fakultas') ?>" method="POST" id="form_sample_2" class="form-horizontal" novalidate="novalidate">
                            <?= csrf_field() ?>
								<div class="form-body">
                                    <?php if($validation->hasError('kode_fakultas') || $validation->hasError('nama_fakultas')) { ?>
									...
									<div class="form-group <?= ($validation->hasError('kode_fakultas')) ? 'has-error' :'' ?>">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" placeholder="Buat kode fakultas" name="kode_fakultas" value="<?= old('kode_fakultas') ?>" autofocus>
									...
									<div class="form-group <?= ($validation->hasError('nama_fakultas')) ? 'has-error' :'' ?>">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" placeholder="Buat nama fakultas" name="nama_fakultas" value="<?= old('nama_fakultas') ?>">
											<span class="help-inline">
